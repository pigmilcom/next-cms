        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} modal={false} {...props}>
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden rounded-lg rounded-tl-none rounded-bl-none sm:rounded-none"
                    style={
                        {
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
    ...
    return (
        <button
            ...
            className={cn(
                '-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-0.5 after:bg-[#f5f5f5]/70 group-data-[side=right]:left-0 sm:flex dark:after:bg-[#2d2d2d]/70',
