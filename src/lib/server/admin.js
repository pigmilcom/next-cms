...
export async function createUser(userData) {
    try {
        ...
        const newUser = {
            ...
            countryIso: userDataToStore.countryIso || '',
            streetAddress: userDataToStore.streetAddress || '',
            apartmentUnit: userDataToStore.apartmentUnit || '',
            city: userDataToStore.city || '',
            state: userDataToStore.state || '',
            zipCode: userDataToStore.zipCode || '',
