...
/**
 * BLANK PAGE - CLIENT COMPONENT
 *
 * Minimal boilerplate for creating new pages.
...
const BlankPageClient = () => {
    ...
    useEffect(() => {
        ...
        if(!isLoading) {
            toast.success('Blank page loaded successfully!');
    ...
    return (
        <motion.div
            ...
            <div className="flex flex-col gap-4 mb-6">
                ...
                <p className="text-muted-foreground">Minimal boilerplate for new pages</p>
            </div> 
        </motion.div>
    );
};

export default BlankPageClient;
